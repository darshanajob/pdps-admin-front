      ...
      <div className="page-content">
        <Container fluid>
          ...
          <Breadcrumbs
            ...
            breadcrumbItemType={props.t("Other")}
            breadcrumbItem={props.t("Remove trees")}
          />
              ...
              <Card>
                <CardBody className="service-heading">
                  <CardTitle className="h4 text-lg-center">
                    {props.t("Removal of hazardous conditions caused by trees")}
                  </CardTitle>
                </CardBody>
                <CardBody>
...
export default withTranslation()(TreeCut)
