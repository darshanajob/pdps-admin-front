  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title={props.t("Services")} breadcrumbItemType={props.t("Taxes and rents")}  breadcrumbItem={props.t("Business & industry")} />
...
export default withTranslation()(TaxBusiness);
