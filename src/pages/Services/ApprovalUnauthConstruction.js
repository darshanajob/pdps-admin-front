...
const ApprovalUnauthConstruction = props => {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title={props.t("Services")}  breadcrumbItemType={props.t("Get Approvals")} breadcrumbItem={props.t("Unauthorized construction")} />
              ...
              <Card>
                <CardBody className="service-heading">
                  <CardTitle className="h4 text-lg-center">
                    {props.t("Approval of cover for unauthorized construction")}
                  </CardTitle>
                </CardBody>
                <CardBody>
...
export default withTranslation()(ApprovalUnauthConstruction);
