  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title={props.t("Services")}  breadcrumbItemType={props.t("Other")} breadcrumbItem={props.t("Access to information")} />
              ...
              <Card>
                <CardBody className="service-heading">
                  <CardTitle className="h4 text-lg-center">
                    {props.t("Access to information under the Information Act")}
                  </CardTitle>
                </CardBody>
                <CardBody>
...
export default withTranslation()(InformationAccess);
