...
const PropertyRegistration = props => {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title={props.t("Services")}  breadcrumbItemType={props.t("Other")} breadcrumbItem={props.t("Property title")} />
              ...
              <Card>
                <CardBody className="service-heading">
                  <CardTitle className="h4 text-lg-center">
                    {props.t("Registration and amendment of property title")}
                  </CardTitle>
                </CardBody>
                <CardBody>
...
export default withTranslation()(PropertyRegistration);
