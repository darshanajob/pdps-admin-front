...
const CertificateCompliance = props => {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title={props.t("Services")}  breadcrumbItemType={props.t("License & certificates")} breadcrumbItem={props.t("Compliance")} />
...
export default withTranslation()(CertificateCompliance);
