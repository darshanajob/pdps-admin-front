  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title={props.t("Services")}  breadcrumbItemType={props.t("License & certificates")} breadcrumbItem={props.t("Development permit")} />
              ...
              <Card>
                <CardBody className="service-heading">
                  <CardTitle className="h4 text-lg-center">
                    {props.t("Extension of validity of a development permit")}
                  </CardTitle>
                </CardBody>
                <CardBody>
...
export default withTranslation()(PermitDevelopment);
