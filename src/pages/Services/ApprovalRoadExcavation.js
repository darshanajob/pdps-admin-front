...
const ApprovalRoadExcavation = props => {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title={props.t("Services")}  breadcrumbItemType={props.t("Get Approvals")} breadcrumbItem={props.t("Damage roads")} />
...
export default withTranslation()(ApprovalRoadExcavation);
