...
const ApprovalLandDivision = props => {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title={props.t("Services")}  breadcrumbItemType={props.t("Get Approvals")} breadcrumbItem={props.t("Land subdivision")} />
              ...
              <Card>
                <CardBody className="service-heading">
                  <CardTitle className="h4 text-lg-center">
                    {props.t("Approval of land subdivision and consolidation development plans")}
                  </CardTitle>
                </CardBody>
                <CardBody>
...
export default withTranslation()(ApprovalLandDivision);
