...
const CertificateStreetBuilding = props => {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title={props.t("Services")}  breadcrumbItemType={props.t("License & certificates")} breadcrumbItem={props.t("Street Line / Building Limit")} />
              ...
              <Card>
                <CardBody className="service-heading">
                  <CardTitle className="h4 text-lg-center">
                    {props.t("Issuance of Street Line / Building Limit Certificates")}
                  </CardTitle>
                </CardBody>
                <CardBody>
...
export default withTranslation()(CertificateStreetBuilding);
